...
public class ChainMain {
    public static void main(String[] args) {
        ...
        myPageRequest.put("member",Member.createUser("P-C-Space","P-C-Space","1234"));
        ...
        orderPageRequest.put("member",Member.createManager("CHANGMO","창모","1234"));

        Request mainPageRequest = new Request("/main");
        mainPageRequest.put("member",Member.createUser("Leellamarz","릴러말즈","1234"));
